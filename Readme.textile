...
You can *create or edit a page* by editing / creating the @.tx@-file in the @content/@-folder. Eg, create the file @content/somefile.tx@ and you can reach it via @http://yourdomain.tld/somefile.tx@. You can create sub-folders and stuff withunder.
